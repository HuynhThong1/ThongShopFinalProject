                ...
                </div>
                {
                    ...
                    <>
                        ...
                        <div>
                            ...
                            <input id="password" type="text" placeholder="Enter Password" onChange={(e) => setPassword(e.target.value)}/>
                        </div>
                        <div>
                            <label htmlFor="confirmPassword">Confirm Password</label>
                            <input id="password" type="text" placeholder="Enter Confirm Name" onChange={(e) => setConfirmPassword(e.target.value)}/>
                        </div>
                        {
                            user.isSeller && (
                                <>
